        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-dark border border-dark">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                  <form action={{route('pegawai.dokumen.edit', ['id'=>$document->id])}} class="" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('patch')
                    <div class="row">
                        <div class="col-lg-12">
                          <div class="form-group">
                            ...
                            <input type="text" name="title" id="title" class="form-control" placeholder="--judul file--" value="{{ old('title') ?? $document->title}}">
                            @error('title')
                          ...
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              <div class="custom-file">
                                ...
                                <label class="custom-file-label" for="exampleInputFile">{{ $document->file ?? '--pilih file--'}}</label>
                              </div>
                            </div>
                            @error('fileinput')
